...
export const metadata: Metadata = {
  title: "Dashboard | FliX",
  description: "FliX agent dashboard — API overview, pricing, and job history.",
};
    ...
    <main className="min-h-screen flex flex-col bg-[#08090d] font-mono text-slate-300">
      ...
      <div className="flex-1 max-w-5xl mx-auto w-full px-4 py-12 space-y-10">
        ...
        <div className="space-y-2">
          ...
          <h1 className="font-mono font-black text-slate-100 text-2xl uppercase tracking-widest">FliX API</h1>
