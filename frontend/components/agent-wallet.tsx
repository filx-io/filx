...
if res.status_code == 402:
    ...
    print(result["content"])`}</pre>
          ...
          <div className="flex flex-wrap gap-4 pt-2 border-t border-white/5">
            <a href="https://filx.io/docs#wallet" className="inline-flex items-center gap-1.5 font-mono text-xs font-bold text-[#3b82f6] hover:text-white transition-colors">
              filx.io/docs <ExternalLink className="w-3 h-3" />
            </a>
            <a href="https://filx.io/launch" className="inline-flex items-center gap-1.5 font-mono text-xs font-bold text-slate-500 hover:text-slate-300 transition-colors">
